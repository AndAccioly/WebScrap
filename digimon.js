...
puppeteer.launch({ dumpio: true }).then(async browser => {
    const urlBuscada = 'https://www.tcgplayer.com/search/digimon-card-game/next-adventure?productLineName=digimon-card-game&view=grid&setName=next-adventure&page=1'
    ...
    //pegar todos os links das cartas
    let grabCardsLink = await page.evaluate(() => {
        const processarLink = (html) => {
            const URL_BASE = "https://www.tcgplayer.com"
